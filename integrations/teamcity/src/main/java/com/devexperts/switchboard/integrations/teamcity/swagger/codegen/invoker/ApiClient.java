...
import com.devexperts.switchboard.integrations.teamcity.swagger.codegen.invoker.auth.ApiKeyAuth;
import com.devexperts.switchboard.integrations.teamcity.swagger.codegen.invoker.auth.Authentication;
import com.devexperts.switchboard.integrations.teamcity.swagger.codegen.invoker.auth.HttpBasicAuth;
import com.devexperts.switchboard.integrations.teamcity.swagger.codegen.invoker.auth.OAuth;
...
public class ApiClient {
    ...
    public ApiClient(String basePath, String login, String password) {
        json = new JSON();
     ...
     * @throws ApiException API exception
     */
    public <T> ApiResponse<T> invokeAPI(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams,
                                        Map<String, Object> formParams, String accept, String contentType, String[] authNames, GenericType<T> returnType)
            throws ApiException
    {
        updateParamsForAuth(authNames.length > 0 ? authNames : new String[] {"Basic"}, queryParams, headerParams);
